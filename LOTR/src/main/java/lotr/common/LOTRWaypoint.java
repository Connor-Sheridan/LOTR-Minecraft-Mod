...
public enum LOTRWaypoint implements LOTRAbstractWaypoint
{
	...
	MENELTARMA(OCEAN, UNALIGNED, 64, 1733),
	
	HOBBITON(SHIRE, LOTRFaction.HOBBIT, 815, 730),
	BRANDYWINE_BRIDGE(SHIRE, UNALIGNED, 850, 723),
	SARN_FORD(SHIRE, UNALIGNED, 882, 801),
	LONGBOTTOM(SHIRE, LOTRFaction.HOBBIT, 820, 765),
	MICHEL_DELVING(SHIRE, LOTRFaction.HOBBIT, 796, 739),
	WILLOWBOTTOM(SHIRE, LOTRFaction.HOBBIT, 845, 753),
	BRANDY_HALL(SHIRE, LOTRFaction.HOBBIT, 857, 734),
	WHITFURROWS(SHIRE, LOTRFaction.HOBBIT, 840, 727),
	FROGMORTON(SHIRE, LOTRFaction.HOBBIT, 830, 728),
	OATBARTON(SHIRE, LOTRFaction.HOBBIT, 818, 702),
	SCARY(SHIRE, LOTRFaction.HOBBIT, 831, 709),
	NEEDLEHOLE(SHIRE, LOTRFaction.HOBBIT, 806, 708),
	LITTLE_DELVING(SHIRE, LOTRFaction.HOBBIT, 790, 716),
	WAYMEET(SHIRE, LOTRFaction.HOBBIT, 807, 733),
	TUCKBOROUGH(SHIRE, LOTRFaction.HOBBIT, 814, 743),
	NOBOTTLE(SHIRE, LOTRFaction.HOBBIT, 799, 710),
	TIGHFIELD(SHIRE, LOTRFaction.HOBBIT, 778, 712),
	...
	OST_IN_EDHIL(EREGION, UNALIGNED, 1112, 870),
	...
	GOBLIN_TOWN(MISTY_MOUNTAINS, LOTRFaction.GUNDABAD, 1220, 696),
	EAGLES_EYRIE(MISTY_MOUNTAINS, UNALIGNED, 1246, 685),
	
	CARROCK(VALES_OF_ANDUIN, UNALIGNED, 1281, 681),
	...
	BEORN(VALES_OF_ANDUIN, UNALIGNED, 1302, 680),
	FOREST_GATE(VALES_OF_ANDUIN, UNALIGNED, 1293, 628),
	FRAMSBURG(VALES_OF_ANDUIN, UNALIGNED, 1251, 590),
	ARGONATH(VALES_OF_ANDUIN, UNALIGNED, 1341, 1095),
	
	THRANDUIL_HALLS(MIRKWOOD, LOTRFaction.WOOD_ELF, 1424, 633),
	
	DOL_GULDUR(MIRKWOOD_CORRUPTED, LOTRFaction.DOL_GULDUR, 1339, 894),
	MIRKWOOD_MOUNTAINS(MIRKWOOD_CORRUPTED, UNALIGNED, 1430, 672),
	RHOSGOBEL(MIRKWOOD_CORRUPTED, UNALIGNED, 1343, 762),
	...
	CERIN_AMROTH(LOTHLORIEN, LOTRFaction.GALADHRIM, 1230, 897),
	
	DERNDINGLE(FANGORN, LOTRFaction.FANGORN, 1163, 1030),
	WELLINGHALL(FANGORN, LOTRFaction.FANGORN, 1153, 1014),
	TREEBEARD_HILL(FANGORN, LOTRFaction.FANGORN, 1200, 1030),
	...
	ENTWADE(ROHAN, UNALIGNED, 1239, 1104),
	EASTMARK(ROHAN, UNALIGNED, 1286, 1130),
	ALDBURG(ROHAN, UNALIGNED, 1223, 1178),
	GRIMSLADE(ROHAN, UNALIGNED, 1153, 1122),
	
	DUNHARROW(WHITE_MOUNTAINS, UNALIGNED, 1175, 1154),
	TARLANG(WHITE_MOUNTAINS, UNALIGNED, 1205, 1213),
	RAS_MORTHIL(WHITE_MOUNTAINS, UNALIGNED, 845, 1332),
	...
	ERECH(GONDOR, LOTRFaction.GONDOR, 1188, 1204),
	PINNATH_GELIN(GONDOR, UNALIGNED, 1045, 1273),
	ANDUIN_MOUTH(GONDOR, UNALIGNED, 1273, 1369),
	EDHELLOND(GONDOR, LOTRFaction.GONDOR, 1191, 1291),
	PELARGIR(GONDOR, LOTRFaction.GONDOR, 1390, 1348),
	CALEMBEL(GONDOR, LOTRFaction.GONDOR, 1231, 1254),
	ETHRING(GONDOR, UNALIGNED, 1252, 1265),
	HALIFIRIEN(GONDOR, UNALIGNED, 1309, 1205),
	CALENHAD(GONDOR, UNALIGNED, 1330, 1216),
	MINRIMMON(GONDOR, UNALIGNED, 1350, 1224),
	ERELAS(GONDOR, UNALIGNED, 1367, 1225),
	NARDOL(GONDOR, UNALIGNED, 1384, 1228),
	EILENACH(GONDOR, UNALIGNED, 1402, 1228),
	AMON_DIN(GONDOR, UNALIGNED, 1416, 1231),
	HENNETH_ANNUN(GONDOR, LOTRFaction.GONDOR, 1443, 1192),
	LINHIR(GONDOR, UNALIGNED, 1292, 1343),
	ELENDIL(GONDOR, UNALIGNED, 1302, 1207),
	TARNOST(GONDOR, UNALIGNED, 1241, 1298),
	
	TOLFALAS_ISLAND(TOLFALAS, UNALIGNED, 1240, 1414),
	
	AMON_HEN(EMYN_MUIL, UNALIGNED, 1335, 1131),
	AMON_LHAW(EMYN_MUIL, UNALIGNED, 1372, 1120),
	...
	DURTHANG(MORDOR, LOTRFaction.MORDOR, 1464, 1159),
	CARACH_ANGREN(MORDOR, LOTRFaction.MORDOR, 1491, 1166),
	CIRITH_UNGOL(MORDOR, LOTRFaction.MORDOR, 1463, 1231),
	MORIGOST(MORDOR, LOTRFaction.MORDOR, 1558, 1286),
	NARGROTH(MORDOR, LOTRFaction.MORDOR, 1640, 1248),
	AMON_ANGREN(MORDOR, LOTRFaction.MORDOR, 1663, 1245),
	SEREGOST(MORDOR, LOTRFaction.MORDOR, 1680, 1209),
	FELLBEASTS(MORDOR, LOTRFaction.MORDOR, 1754, 1164),
	...
	EASTERN_GUARD(NURN, LOTRFaction.MORDOR, 1828, 1288),
	THAURBAND(NURN, LOTRFaction.MORDOR, 1646, 1354),
	...
	GREAT_PLAINS_SOUTH(FAR_HARAD, UNALIGNED, 1462, 2460),
