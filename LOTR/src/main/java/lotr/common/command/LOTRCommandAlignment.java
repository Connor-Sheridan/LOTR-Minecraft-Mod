    ...
    public void processCommand(ICommandSender sender, String[] input)
    {
        if (input.length > 1)
        {
			...
			if (input[0].equals("set"))
			{
				...
				func_152373_a(sender, this, "commands.lotr.alignment.set", new Object[] {entityplayer.getCommandSenderName(), faction.codeName(), alignment});
				return;
			}
			...
			if (input[0].equals("add"))
			{
				...
				func_152373_a(sender, this, "commands.lotr.alignment.add", new Object[] {alignment, entityplayer.getCommandSenderName(), faction.codeName()});
				return;
			}
        }
